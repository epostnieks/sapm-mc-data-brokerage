#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Data Brokerage / Surveillance / Consent Fabrication Trap
========================================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Data Brokerage / Surveillance (Consent Fabrication Trap).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "data_brokerage",
    "domain_name": "Data Brokerage / Surveillance",
    "theorem": "Consent Fabrication Trap",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 323.0,
    "channels": {
        "C1_security": {
            "dist": "lognormal",
            "low": 130,
            ...
            "high": 270,
            "weight": 0.15,
            "description": "Identity theft, breach remediation, fraud enabled"
        },
        "C2_autonomy_privacy": {
            "dist": "lognormal",
            "low": 320,
            ...
            "high": 700,
            "weight": 0.25,
            "description": "Privacy degradation, surveillance capitalism"
        },
        "C3_democratic": {
            "dist": "lognormal",
            "low": 200,
            ...
            "high": 500,
            "weight": 0.2,
            "description": "Democratic manipulation, disinformation targeting"
        },
        "C4_discrimination": {
            "dist": "lognormal",
            "low": 170,
            ...
            "high": 400,
            "weight": 0.15,
            "description": "Algorithmic discrimination, credit/insurance bias"
        },
        "C5_consumer_manipulation": {
            "dist": "lognormal",
            "low": 260,
            "mid": 390,
            "high": 580,
            "weight": 0.15,
            "description": "Dark patterns, attention hijacking, addiction"
        },
        "C6_governance": {
            "dist": "lognormal",
            "low": 200,
            ...
            "high": 480,
            "weight": 0.1,
            "description": "Consent theater, regulatory capture"
        }
    },
